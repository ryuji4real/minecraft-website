...
Configuration
------------------------
If something doesn't work please contact me on discord (airbourgeois).
*/
...
const config = {
    serverInfo: {
        ...
        serverName: "Burnia", /*Server name*/
        serverIp: "mc.burnia.net", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
    ...
    */
    ...
    adminTeamPage: {
        leaders: [
            ...
            {
                inGameName: "Technoblade",
                rank: "Owner",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(255, 3, 3, 1)"
            },
            {
                inGameName: "PewDiePie",
                rank: "Manager",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
            {
                inGameName: "Wilbur Soot",
                rank: "Moderator",
                skinUrlOrPathToFile: "",
                rankColor: ""
            }
        ...
        developers: [
            {
                inGameName: "TommyInnit",
                rank: "Developer",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
            {
                inGameName: "SteveCraft",
                rank: "Developer",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
            {
                inGameName: "EnderKnight",
                rank: "Webmaster",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
        ...
        helpers: [
            {
                inGameName: "CreeperHunter",
                rank: "Helper++",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
            {
                inGameName: "PixelMiner",
                rank: "Helper++",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
            {
                inGameName: "RedstoneGenius",
                rank: "Helper+",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
            {
                inGameName: "EnderLord",
                rank: "Helper+",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
            {
                inGameName: "ShadowCrafter",
                rank: "Helper",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
            {
                inGameName: "LunarFury",
                rank: "Helper",
                skinUrlOrPathToFile: "",
                rankColor: ""
            }
        ...
        builders: [
            {
                inGameName: "PixelPioneer",
                rank: "Builder++",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
            {
                inGameName: "CraftyBlox",
                rank: "Builder++",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
            {
                inGameName: "AetherGuardian",
                rank: "Builder+",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
            {
                inGameName: "SkyWalkerMC",
                rank: "Builder+",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
            {
                inGameName: "DiamondSeeker",
                rank: "Builder",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
            {
                inGameName: "FrostDragon",
                rank: "Builder",
                skinUrlOrPathToFile: "",
                rankColor: ""
            }
